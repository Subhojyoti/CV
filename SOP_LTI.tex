...
\textbf{4. Humor Recognition:} Humor Recognition is one of the long standing goals in Natural Language Processing. In this \underline{\color{blue}\href{https://github.com/Subhojyoti/subhojyoti.github.io/blob/master/pdf/NLP_Humor_projectReport.pdf}{report}} we first tackle some of the fundamental ideas of what motivates humor and how it can be generated. Then we move on to humor recognition and deal {\color{red} what is deal with? this sentencedoes not provide any information, you havr to ta;lk about your model} with some of the important papers which deals with humor recognition. In the end we propose a model which is a hybrid of Humor Generation and Recognition taking the best elements of both.
