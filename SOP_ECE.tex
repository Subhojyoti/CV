...
%       \hbox to 6.2in { {\it \hfill Carnegie Mellon University  \hfill Ph.D Applicant \hfill} }
       \hbox to 5.5in {\hfill 
       \begin{tabular}{cc} 
       Electrical & Computer Engineering  \& Ph.D. Applicant \\
       University of Wisconsin Madison & Subhojyoti Mukherjee (subho@cs.umass.edu)[\href{https://subhojyoti.github.io/pdf/subho_cv.pdf}{\underline{\color{red}CV}}]
       \end{tabular} \hfill}
...
I believe that a doctoral degree from the Department of Electrical \& Computer Engineering will propel me a long way in my goal to become a professor. Its broad reach and in-depth courses on a  variety of subjects ranging from practical to theoretical applications will help me in my endeavor. Even though my previous experience has mainly centered around different areas of Computer Science, working on learning theory has really made me appreciate the broad scope of information theory. Especially, the area I want to venture into during my doctoral studies requires strong fundamentals of information theory (such as stochastic random processes and concentration measure theory), and it is the main motivation in applying to this department. There are several professors at University of Wisconsin Madison such as \textbf{Dr. Robert Nowak}, \textbf{Dr. Karl Rohe}, and \textbf{Dr. Laurent Lessard} whose publications/projects are especially appealing to me. All of these faculties work in the areas that I know of and I am interested to work with them for my doctoral research. Also, I will be grateful if the admission committee can find a suitable fit for me in the deparment based on my research experience and interests.
