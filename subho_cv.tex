...
\address{Phone: +91 97486 83510 \\Email: \texttt{subho@cse.iitm.ac.in}}
...
\\Guides: Prof.~Balaraman Ravindran and Prof.~Nandan Sudarsanam\\CGPA: 8.22/10
\\[0.25cm]
...
\item Subhojyoti Mukherjee, K.P.~Naveen, Nandan Sudarsanam, and Balaraman Ravindran, ``\textit{Thresholding Bandit with Augmented UCB},'' accepted in the proceedings of IJCAI 2017.
\item Subhojyoti Mukherjee, K.P.~Naveen, Nandan Sudarsanam, and Balaraman Ravindran, ``\textit{Efficient UCBV: An Almost Optimal Algorithm using Variance Estimates},'' under review for ECML 2017.
\end{enumerate}
...
\section{REFERENCES}
\begin{tabular}{lll}
\textbf{Prof.~Balaraman Ravindran} & \textbf{Prof.~Nandan Sudarsanam} \\
