...
%       \hbox to 6.2in { {\it \hfill Carnegie Mellon University  \hfill Ph.D Applicant \hfill} }
       \hbox to 5.5in {\hfill 
       \begin{tabular}{cc} 
       Department of Statistics \& Data Science  & Ph.D. Applicant \\
...
I believe that a doctoral degree from the Department of Statistics \& Data Science will propel me a long way in my goal to become a professor in Statistics. Its broad reach and in-depth courses on a variety of subjects ranging from practical to theoretical applications will help me in my endeavor. Even though my previous experience has mainly centered around different areas of Computer Science, working on learning theory has really made me appreciate the broad scope of statistical learning theory. Especially, the area I want to venture into during my doctoral studies requires strong fundamentals of statistics (such as stochastic random processes and concentration measure theory) which is the main motivation in applying to this department. There are several professors at Carnegie Mellon University such as \textbf{Dr. Aaditya Ramdas}, \textbf{Dr. David Choi}, and \textbf{Dr. Larry Wasserman} whose publications/projects are especially appealing to me. All of these faculties work in the areas that I know of, and I am interested to work with them for my doctoral research. I have previously communicated with \underline{\color{red}\href{http://www.stat.cmu.edu/~aramdas/}{Dr. Aaditya Ramdas}} and \underline{\color{red}\href{http://www.andrew.cmu.edu/user/davidch/}{Dr. David Choi}} during my visits to CMU and I found their work extremely engaging. Also, I will be grateful if the admission committee can find a suitable fit for me in the deparment based on my research experience and interests.
