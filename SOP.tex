...
%        \hfill Fall 2018} }
       ...
       \vspace{2mm}
       %\begin{center}
       \hbox to 5.28in { {\it \hfill Department: Computer Science  \hfill Applicant: Subhojyoti Mukherjee} }
       %\end{center}
      \vspace{2mm}}
   }
   \end{center}
